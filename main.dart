...
class _HomeState extends State<Home> {
  ...
  Future sendImage(ImageSource media) async {
    ...
    var uri = "http://192.168.1.253/latihan/flutter_upload_image/create.php";
  ...
  Future getImageServer() async {
    try {
      final response = await http.get(Uri.parse(
          'http://192.168.1.253/latihan/flutter_upload_image/list.php'));
            ...
            ? GridView.builder(
                ...
                itemBuilder: (_, index) {
                  return Padding(
                    ...
                    child: Image(
                      image: NetworkImage(
                          'http://192.168.1.253/latihan/flutter_upload_image/images/' +
                              _images[index]['image']),
                      fit: BoxFit.cover,
                    ),
                  );
